...
public class DynamicDBUtil {
    ...
    /**
     * Executes the SQL statement in this <code>PreparedStatement</code> object, which must be an
     * SQL Data Manipulation Language (DML) statement, such as <code>INSERT</code>,
