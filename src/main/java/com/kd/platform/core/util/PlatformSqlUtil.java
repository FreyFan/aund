...
import com.kd.platform.core.def.ConstantsDefs;

/**
 * @author Frey.Fan
 */
public class PlatformSqlUtil {
    ...
    public static String getMethodSqlLogic(String methodUrl) {
        ...
        String projectPath = getAppPath(PlatformSqlUtil.class);
    ...
    public static String getMethodSqlLogicJar(String methodUrl) {
        ...
        // 返回读取指定资源的输入流
        InputStream is = PlatformSqlUtil.class.getResourceAsStream(sqlurl);
    ...
    public static void main(String[] args) {
        // LogUtil.info(getAppPath(PlatformSqlUtil.class));
        LogUtil.info(getCountSqlBySql("SELECT * 	from PLATFORM_DICT_PARAM WHERE 1=1"));
    }
