...
public class LdapUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
         * 假设address.txt中存在如下信息,一个是员工号,一个是手机号,当然也可以加其他内容进来 OP036616,13111111111 OP018479,13122222222
         * OP017591,13233333333 OP032528,13244444444
         */
        ...
        for (int i = 0; i < lineContextArray.length; i++) {
            if (lineContextArray[i] == null) continue;
