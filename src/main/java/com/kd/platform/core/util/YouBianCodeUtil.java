...
/**
 * <b>Application name:</b> YouBianCodeUtil.java <br>
 * <b>Application describing: 流水号生成规则(按默认规则递增，数字从1-99开始递增，数字到99，递增字母;位数不够增加位数) A001 A001A002</b> <br>
...
public class YouBianCodeUtil {
    ...
    /**
     * 根据父亲code,获取下级的下一个code 例如：父亲CODE:A01 当前CODE:A01B03 获取的code:A01B04
     * @param parentCode
     * @return
     */
