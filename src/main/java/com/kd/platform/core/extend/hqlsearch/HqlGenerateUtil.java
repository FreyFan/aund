package com.kd.platform.core.extend.hqlsearch;
...
import com.kd.platform.core.annotation.query.QueryTimeFormat;
...
import com.kd.platform.core.util.JSONHelper;
...
import com.kd.platform.web.demo.entity.test.QueryCondition;
...
public class HqlGenerateUtil {
            ...
            try {
                ...
                if (type.contains("class java.lang") || type.contains("class java.math")) {
                    ...
                    if (isHaveRuleData(ruleMap, aliasName) || (isNotEmpty(param) && itIsNotAllEmpty(param))) {
                        ...
                        // ------------end--Author:Frey.Fan Date:20140521 for：用户反馈
    ...
    private static Map<String, TSDataRule> getRuleMap() {
        ...
        List<TSDataRule> list = PlatformDataAutorUtils.loadDataSearchConditonSQL(); // (List<TSDataRule>)
                                                                                    // ContextHolderUtils
