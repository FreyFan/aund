package com.kd.platform.core.enums;
...
public enum SysThemesEnum {
    ...
    DEFAULT_STYLE("default", "main/main", "default", "经典风格"), SHORTCUT_STYLE("shortcut", "main/shortcut_main", "default", "ShortCut风格"), SLIDING_STYLE("sliding", "main/sliding_main", "default", "Sliding云桌面"), ACE_STYLE("ace", "main/ace_main", "metro", "ACE平面风格");
    ...
    public static SysThemesEnum toEnum(String style) {
        if (StringUtil.isEmpty(style)) {
            return ACE_STYLE;//ACE_STYLE  SHORTCUT_STYLE
        }
