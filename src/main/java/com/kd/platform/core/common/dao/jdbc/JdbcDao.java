package com.kd.platform.core.common.dao.jdbc;
...
/**
 * <b>Application name:</b> JdbcDao.java <br>
...
public class JdbcDao extends SimpleJdbcTemplate {
    ...
    public List<Map<String, Object>> findForJdbc(String sql, int page, int rows) {
        // 封装分页SQL
        sql = platformCreatePageSql(sql, page, rows);
     ...
     * 按照数据库类型，封装SQL
     */
    public static String platformCreatePageSql(String sql, int page, int rows) {
