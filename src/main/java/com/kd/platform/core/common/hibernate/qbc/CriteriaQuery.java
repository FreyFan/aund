...
import com.kd.platform.tag.vo.datatable.SortInfo;

/**
 * <b>Application name:</b> CriteriaQuery.java <br>
 * <b>Application describing:CriteriaQuery类是对hibernate QBC查询方法的封装，需要的参数是当前操作的实体类 </b> <br>
