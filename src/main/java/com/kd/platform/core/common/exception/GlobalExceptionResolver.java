...
/**
 * <b>Application name:</b> GlobalExceptionResolver.java <br>
 * <b>Application describing: spring mvc 全局处理异常捕获 根据请求区分ajax和普通请求，分别进行响应. 第一、异常信息输出到日志中。
 * 第二、截取异常详细信息的前50个字符，写入日志表中t_s_log。</b> <br>
