...
import com.kd.platform.core.common.dao.ICommonDao;
...
import com.kd.platform.core.common.model.json.ImportFile;
import com.kd.platform.core.common.model.json.TreeGrid;
import com.kd.platform.core.extend.swftools.SwfToolsUtil;
import com.kd.platform.core.extend.template.DataSourceMap;
import com.kd.platform.core.extend.template.Template;
import com.kd.platform.core.util.*;
...
import com.kd.platform.web.system.pojo.base.*;
...
/**
 * <b>Application name:</b> CommonDao.java <br>
 * <b>Application describing: 公共扩展方法</b> <br>
...
public class CommonDao extends GenericBaseCommonDao implements ICommonDao, IGenericBaseCommonDao {
    ...
    public HttpServletResponse viewOrDownloadFile(UploadFile uploadFile) {
        ...
        if (uploadFile.getRealPath() != null && uploadFile.getContent() == null) {
            ...
            if (uploadFile.getContent() != null) bis = new ByteArrayInputStream(uploadFile.getContent());
