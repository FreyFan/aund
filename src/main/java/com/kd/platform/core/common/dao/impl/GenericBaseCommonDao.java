package com.kd.platform.core.common.dao.impl;
...
import com.kd.platform.core.annotation.PlatformEntityTitle;
import com.kd.platform.core.common.dao.IGenericBaseCommonDao;
...
import com.kd.platform.core.common.hibernate.qbc.DetachedCriteriaUtil;
import com.kd.platform.core.common.hibernate.qbc.HqlQuery;
import com.kd.platform.core.common.hibernate.qbc.PageList;
import com.kd.platform.core.common.hibernate.qbc.PagerUtil;
import com.kd.platform.core.common.model.common.DBTable;
import com.kd.platform.core.common.model.json.DataGridReturn;
import com.kd.platform.core.util.LogUtil;
import com.kd.platform.core.util.MyBeanUtils;
import com.kd.platform.core.util.ToEntityUtil;
import com.kd.platform.core.util.oConvertUtils;
import com.kd.platform.tag.vo.datatable.DataTableReturn;

/**
 * <b>Application name:</b> GenericBaseCommonDao.java <br>
 * <b>Application describing: DAO层泛型基类</b> <br>
...
public abstract class GenericBaseCommonDao<T, PK extends Serializable> implements IGenericBaseCommonDao {
    ...
    public List<Map<String, Object>> findForJdbc(String sql, int page, int rows) {
        // 封装分页SQL
        sql = JdbcDao.platformCreatePageSql(sql, page, rows);
