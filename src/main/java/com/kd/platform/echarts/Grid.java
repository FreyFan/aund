...
/**
 * <b>Application name:</b> Grid.java <br>
 * <b>Application describing:直角坐标系内绘图网格 </b> <br>
...
public class Grid extends Basic<Grid> implements Component {
    ...
    /**
     * 直角坐标系内绘图网格（不含坐标轴）宽度，默认为总宽度 - x - x2，数值单位px，指定width后将忽略x2，见下图。 支持百分比（字符串），如'50%'(显示区域一半的宽度)
     */
    private Object width;

    /**
     * 直角坐标系内绘图网格（不含坐标轴）高度，默认为总宽度 - y - y2，数值单位px，指定height后将忽略y2，见下图。 支持百分比（字符串），如'50%'(显示区域一半的高度)
     */
