...
import com.kd.platform.echarts.code.Calculation;
import com.kd.platform.echarts.code.SelectedMode;
import com.kd.platform.echarts.code.SeriesType;

/**
 * <b>Application name:</b> Map.java <br>
 * <b>Application describing: 地图</b> <br>
...
public class Map extends Series<Map> {
     ...
     * @see com.kd.platform.echarts.code.SelectedMode
     */
    private Object selectedMode;

    /**
     * 地图类型，支持world，china及全国34个省市自治区。省市自治区的mapType直接使用简体中文
     * 支持子区域模式，通过主地图类型扩展出所包含的子区域地图，格式为'主地图类型|子区域名称'，如 'world|Brazil'，'china|广东'
     */
     ...
     * @see com.kd.platform.echarts.code.Calculation
     */
