...
import com.kd.platform.echarts.code.Sort;
import com.kd.platform.echarts.series.force.Category;
...
/**
 * <b>Application name:</b> Chord.java <br>
...
public class Chord extends Series<Chord> {
    ...
    /**
     * ribbonType的和弦图节点使用扇形绘制，边使用有大小端的ribbon绘制，可以表示出边的权重，图的节点边之间必须是双向边，非ribbonType的和弦图节点使用symbol绘制，
     * 边使用贝塞尔曲线，不能表示边的权重，但是可以使用单向边
     */
