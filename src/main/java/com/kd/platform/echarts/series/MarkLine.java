...
import com.kd.platform.echarts.AbstractData;
import com.kd.platform.echarts.style.ItemStyle;

/**
 * <b>Application name:</b> MarkLine.java <br>
...
public class MarkLine extends AbstractData<MarkLine> {
     ...
     * @see com.kd.platform.echarts.series.Series#symbolSize
     */
    private Object symbolSize;

    /**
     * 标线起始和结束的symbol旋转控制，同series中的symbolRotate
     * @see com.kd.platform.echarts.series.Series#symbolRoate
     */
    private Object symbolRoate;

    /**
     * 标线图形炫光特效
     * @see com.kd.platform.echarts.series.Effect
     */
    private Effect effect;

    /**
     * 标线图形样式属性
     * @see com.kd.platform.echarts.style.ItemStyle
     * @see com.kd.platform.echarts.series.Series#itemStyle
     */
    private ItemStyle itemStyle;

    /**
     * 地图特有，标线图形定位坐标
     * @see com.kd.platform.echarts.series.Map#geoCoord
     */
