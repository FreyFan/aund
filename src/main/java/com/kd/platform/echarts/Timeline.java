...
import com.kd.platform.echarts.code.ControlPosition;
import com.kd.platform.echarts.code.TimeLineType;
import com.kd.platform.echarts.style.CheckpointStyle;
import com.kd.platform.echarts.style.ControlStyle;
import com.kd.platform.echarts.style.LineStyle;

/**
 * <b>Application name:</b> Timeline.java <br>
...
public class Timeline extends AbstractData<Timeline> implements Component {
     ...
     * @see com.kd.platform.echarts.code.TimeLineType
     */
    ...
    /**
     * 默认值 auto 时间轴宽度，默认为总宽度 - x - x2，数值单位px，指定width后将忽略x2。见下图。 支持百分比（字符串），如'50%'(显示区域一半的宽度)
     */
     ...
     * @see com.kd.platform.echarts.code.ControlPosition
     */
    ...
    /**
     * 时间轴当前点
     * @see com.kd.platform.echarts.style.CheckpointStyle
     */
     ...
     * @see com.kd.platform.echarts.code.Symbol
     * @see com.kd.platform.echarts.series.Series#symbol
     */
