package com.kd.platform.codegenerate.window;
...
/**
 * <b>Application name:</b> CodeWindow.java <br>
 * <b>Application describing: 单表模型生成的窗口化主类</b> <br>
    ...
    public CodeWindow() {
        ...
        confirmbtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    boolean tableexist = new PlatformReadTable().checkTableExist(CodeWindow.tableName);
                    if (tableexist) {
