...
/**
 * <b>Application name:</b> FormValidationTag.java <br>
 * <b>Application describing: 表单校验</b> <br>
...
public class FormValidationTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            /*
             * // if(cssTheme==null){//手工设置值优先 Cookie[] cookies = ((HttpServletRequest)
             * super.pageContext .getRequest()).getCookies(); for (Cookie cookie : cookies) { if
             * (cookie == null || StringUtils.isEmpty(cookie.getName())) { continue; } if
