...
public class BaseTag extends TagSupport {
    ...
    public int doEndTag() throws JspException {
        try {
            ...
            /*
             * // update-start--Author:longjb Date:20150408 for：手动设置指定属性主题优先 //if (cssTheme == null)
             * {// Cookie[] cookies = ((HttpServletRequest) super.pageContext
             * .getRequest()).getCookies(); for (Cookie cookie : cookies) { if (cookie == null ||
             * StringUtils.isEmpty(cookie.getName())) { continue; } if
             * (cookie.getName().equalsIgnoreCase("PLATFORMCSSTHEME")) { cssTheme =
             * cookie.getValue(); } } //} if(cssTheme==null||"".equals(cssTheme)){
             * cssTheme="default"; }
             */
            ...
            if (oConvertUtils.isIn("zTree", types)) {
                sb.append("<script src=\"plug-in/zTree-3.5.14/js/jquery.ztree.core-3.5.js\" type=\"text/javascript\"></script>");
                sb.append("<link href=\"plug-in/zTree-3.5.14/css/demo.css\" rel=\"stylesheet\" type=\"text/css\" />");
                sb.append("<link href=\"plug-in/zTree-3.5.14/css/zTreeStyle/zTreeStyle.css\" rel=\"stylesheet\" type=\"text/css\" />");
            }
