...
import com.kd.platform.tag.vo.easyui.ColumnValue;
import com.kd.platform.tag.vo.easyui.DataGridColumn;
import com.kd.platform.tag.vo.easyui.DataGridUrl;
import com.kd.platform.tag.vo.easyui.OptTypeDirection;
...
public class DataGridTag extends TagSupport {
    ...
    private String extendParams;// 扩展参数,easyui有的,但是platform没有的参数进行扩展
    ...
    public void setColumn(String title, String field, Integer width, String rowspan, String colspan, String align, boolean sortable, boolean checkbox, String formatter, boolean hidden, String replace, String treefield, boolean image, String imageSize, boolean query, String url, String funname, String arg, String queryMode, String dictionary, boolean popup, boolean frozenColumn, String extend, String style, String downloadName, boolean isAuto, String extendParams) {
        ...
        if (!StringUtils.isBlank(dictionary) && (!popup)) {
            if (dictionary.contains(",")) {
                ...
                String text = "";
                String value = "";
                String sql = "select " + dic[1] + " as field," + dic[2] + " as text from " + "PLATFORM." + dic[0];
                systemService = ApplicationContextUtil.getContext().getBean(SystemService.class);
                        ...
                        if ("single".equals(col.getQueryMode())) {
                            if (!StringUtil.isEmpty(col.getReplace())) {
                                ...
                                if (col.getDictionary().contains(",") && col.isPopup()) {
                                    ...
                                    // <input type="text" name="order_code" style="width: 100px"
    ...
    private String getAutoSpan(String filed, String extend) {
        ...
        nsb.append("$(document).ready(function() {").append("$(\"#" + getEntityName() + "_" + id + "\").autocomplete(\"commonController.do?getAutoList\",{").append("max: 5,minChars: 2,width: 200,scrollHeight: 100,matchContains: true,autoFill: false,extraParams:{").append("featureClass : \"P\",style : \"full\",	maxRows : 10,labelField : \"" + filed + "\",valueField : \"" + filed + "\",")
                .append("searchField : \"" + filed + "\",entityName : \"" + getEntityName() + "\",trem: function(){return $(\"#" + getEntityName() + "_" + id + "\").val();}}");
        nsb.append(",parse:function(data){return platformAutoParse.call(this,data);}");
