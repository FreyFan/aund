...
/**
 * <b>Application name:</b> MailUtil.java <br>
 * <b>Application describing: 邮箱发送辅助类</b> <br>
...
public class MailUtil {
    ...
    public static void main(String[] args) {
        try {
            sendEmail("smtp.163.com", "294002850@qq.com", "系统测试邮件", "hi,all,I am AnChao!111", "Frey.Fan@163.com", "Frey.Fan@163.com", "zhu52571314zhu");
            PropertiesUtil util = new PropertiesUtil("sysConfig.properties");
            sendEmail(util.readProperty("mail.smtpHost"), "294002850@qq.com", "系统测试邮件", "hi,all,I am AnChao!nana", util.readProperty("mail.sender"), util.readProperty("mail.user"), util.readProperty("mail.pwd"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
