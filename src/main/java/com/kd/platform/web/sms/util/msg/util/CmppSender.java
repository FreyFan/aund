...
import com.kd.platform.web.sms.util.msg.domain.MsgActiveTestResp;
import com.kd.platform.web.sms.util.msg.domain.MsgCommand;
import com.kd.platform.web.sms.util.msg.domain.MsgConnectResp;
import com.kd.platform.web.sms.util.msg.domain.MsgDeliver;
import com.kd.platform.web.sms.util.msg.domain.MsgDeliverResp;
import com.kd.platform.web.sms.util.msg.domain.MsgHead;
import com.kd.platform.web.sms.util.msg.domain.MsgSubmitResp;

/**
 * <b>Application name:</b> CmppSender.java <br>
 * <b>Application describing:启动一个线程去接收和发送数据，如果队列处理完毕就关闭线程 </b> <br>
