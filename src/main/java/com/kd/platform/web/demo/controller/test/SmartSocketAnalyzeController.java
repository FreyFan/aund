 ...
 */
@Controller
@RequestMapping("/smartSocketAnalyzeController")
public class SmartSocketAnalyzeController extends BaseController {
    /**
    ...
    public ModelAndView studentStatisticTabs(HttpServletRequest request) {
        ...
        return new ModelAndView("platform/demo/base/report/SmartSocketAnalyze");
    }
