...
import com.kd.platform.web.demo.entity.test.OptimisticLockingEntity;
import com.kd.platform.web.demo.service.test.OptimisticLockingServiceI;
...
public class OptimisticLockingController extends BaseController {
    ...
    public ModelAndView optimisticLocking(HttpServletRequest request) {
        return new ModelAndView("platform/demo/test/optimisticLockingList");
    }
    ...
    public ModelAndView addorupdate(OptimisticLockingEntity optimisticLocking, HttpServletRequest req) {
        ...
        return new ModelAndView("platform/demo/test/optimisticLocking");
    }
}
