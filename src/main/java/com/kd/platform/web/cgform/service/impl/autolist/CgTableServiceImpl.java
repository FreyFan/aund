package com.kd.platform.web.cgform.service.impl.autolist;
...
/**
 * <b>Application name:</b> CgTableServiceImpl.java <br>
 * <b>Application describing: 动态表数据服务实现</b> <br>
...
public class CgTableServiceImpl extends CommonServiceImpl implements CgTableServiceI {
    ...
    public boolean delete(String table, Object id) {
        try {
            ...
            // --------longjb-start--20150526 ----for:add step.3
            // 判断是否有附件字段,进行连带删除附件及附件表---------------
    ...
    private void dealQuerySql(String table, String field, Map params, StringBuilder sqlB) {
        ...
        sqlB.append(" FROM " + "PLATFORM." + table);
        if (params.size() >= 1) {
        ...
        Object dataRuleSql = PlatformDataAutorUtils.loadDataSearchConditonSQLString();// ContextHolderUtils.getRequest().getAttribute(Globals.MENU_DATA_AUTHOR_RULE_SQL);
