...
import com.kd.platform.web.cgform.service.config.DbTableServiceI;
import com.kd.platform.web.cgform.service.impl.config.DbTableMysqlHandleImpl;
import com.kd.platform.web.cgform.service.impl.config.DbTableOracleHandleImpl;
import com.kd.platform.web.cgform.service.impl.config.DbTablePostgresHandleImpl;
import com.kd.platform.web.cgform.service.impl.config.DbTableServiceMysqlImpl;
import com.kd.platform.web.cgform.service.impl.config.TableSQLServerHandleImpl;
...
/**
 * 数据库工具类
 * @author jueyue 2013年7月6日
 */
public class DbTableUtil {

    /**
     * 获取列的Map key 是 cloumn_name value 是 List<Map<String, Object>>
     * @param queryForList
     * @return
     */
