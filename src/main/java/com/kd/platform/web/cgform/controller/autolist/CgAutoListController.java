package com.kd.platform.web.cgform.controller.autolist;
...
import com.kd.platform.web.cgform.engine.FreemarkerHelper;
import com.kd.platform.web.cgform.entity.config.CgFormFieldEntity;
import com.kd.platform.web.cgform.service.autolist.CgTableServiceI;
import com.kd.platform.web.cgform.service.autolist.ConfigServiceI;
import com.kd.platform.web.cgform.service.config.CgFormFieldServiceI;
import com.kd.platform.web.cgform.util.QueryParamUtil;
...
public class CgAutoListController extends BaseController {
    ...
    public void list(String id, HttpServletRequest request, HttpServletResponse response) {
        ...
        String html = viewEngine.parseTemplate("/com/kd/platform/web/cgform/engine/autolist/autolist.ftl", paras);
        try {
    ...
    public void datagrid(String configId, String page, String field, String rows, String sort, String order, HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
        Object dataRuleSql = PlatformDataAutorUtils.loadDataSearchConditonSQLString(); // request.getAttribute(Globals.MENU_DATA_AUTHOR_RULE_SQL);
        long start = System.currentTimeMillis();
        // step.1 获取动态配置
