package com.kd.platform.web.cgform.controller.cgformftl;
...
import com.kd.platform.core.common.model.common.UploadFile;
...
import com.kd.platform.core.util.FormUtil;
...
import com.kd.platform.web.cgform.common.OfficeHtmlUtil;
import com.kd.platform.web.cgform.entity.cgformftl.CgformFtlEntity;
import com.kd.platform.web.cgform.service.cgformftl.CgformFtlServiceI;
import com.kd.platform.web.cgform.service.config.CgFormFieldServiceI;
import com.kd.platform.web.system.service.SystemService;

/**
 * <b>Application name:</b> CgformFtlController.java <br>
 * <b>Application describing:上传Word转换为freemarker表单 </b> <br>
...
public class CgformFtlController extends BaseController {
    ...
    public ModelAndView ckeditor(HttpServletRequest request, String id) {
        ...
        if (request.getParameter("editorType") == null) {
            return new ModelAndView("platform/cgform/cgformftl/ckeditor");
        } else {
            return new ModelAndView("platform/cgform/cgformftl/" + request.getParameter("editorType"));
        }
    }
    ...
    public ModelAndView cgformFtl(HttpServletRequest request) {
        ...
        return new ModelAndView("platform/cgform/cgformftl/cgformFtlList");
    }
    ...
    public ModelAndView addorupdate(CgformFtlEntity cgformFtl, HttpServletRequest req) {
        ...
        if ("02".equals(cgformFtl.getEditorType())) {
            return new ModelAndView("platform/cgform/cgformftl/cgformFtlUEditor");
        } else if ("03".equals(cgformFtl.getEditorType())) {
            return new ModelAndView("platform/cgform/cgformftl/cgformFtl");
        } else {
            return new ModelAndView("platform/cgform/cgformftl/cgformFtlEditor");
        }
    }
    ...
    public AjaxJson saveWordFiles(HttpServletRequest request, HttpServletResponse response, CgformFtlEntity cgformFtl) {
        ...
        String cgformId = oConvertUtils.getString(request.getParameter("cgformId"));// formid
        String cgformName = oConvertUtils.getString(request.getParameter("cgformName"));// formname
        String ftlStatus = oConvertUtils.getString(request.getParameter("ftlStatus"));// formStatus
    ...
    public ModelAndView cgformFtl2(HttpServletRequest request) {
        String formid = request.getParameter("formid");
        request.setAttribute("formid", formid);
        return new ModelAndView("platform/cgform/cgformftl/cgformFtlList2");
    }
    ...
    public AjaxJson saveEditor(CgformFtlEntity cgformFtl, HttpServletRequest request) {
        ...
        if (oConvertUtils.isEmpty(ftlStatus)) ftlStatus = "0";
        ...
        if (StringUtil.isNotEmpty(fileKey)) {
            cgformFtl.setId(fileKey);
            if (StringUtil.isNotEmpty(ftlVersion)) cgformFtl.setFtlVersion(Integer.valueOf(ftlVersion));
            if (StringUtil.isNotEmpty(ftlWordUrl)) cgformFtl.setFtlWordUrl(ftlWordUrl);
            if (StringUtil.isNotEmpty(createBy)) cgformFtl.setCreateBy(createBy);
            if (StringUtil.isNotEmpty(createName)) cgformFtl.setCreateName(createName);
            if (StringUtil.isNotEmpty(createDate)) cgformFtl.setCreateDate(DateUtils.str2Date(createDate, DateUtils.date_sdf));
