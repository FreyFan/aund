package com.kd.platform.web.cgform.service.impl.config;
...
import com.kd.platform.web.cgform.common.CgAutoListConstant;
import com.kd.platform.web.cgform.dao.config.CgFormFieldDao;
import com.kd.platform.web.cgform.dao.config.CgFormVersionDao;
...
import com.kd.platform.web.cgform.entity.config.CgSubTableVO;
import com.kd.platform.web.cgform.entity.enhance.CgformEnhanceJsEntity;
import com.kd.platform.web.cgform.exception.BusinessException;
...
import com.kd.platform.web.cgform.service.config.DbTableHandleI;
import com.kd.platform.web.cgform.service.enhance.CgformEnhanceJsServiceI;
import com.kd.platform.web.cgform.service.impl.config.util.DbTableProcess;
import com.kd.platform.web.cgform.service.impl.config.util.DbTableUtil;
import com.kd.platform.web.cgform.util.PublicUtil;
import com.kd.platform.web.system.pojo.base.TSOperation;
import org.apache.commons.lang.StringUtils;
import org.apache.log4j.Logger;
import com.kd.platform.core.annotation.Ehcache;
...
public class CgFormFieldServiceImpl extends CommonServiceImpl implements CgFormFieldServiceI {
    ...
    private boolean databaseFieldIsChange(CgFormFieldEntity oldColumn, CgFormFieldEntity newColumn) {
        if (!PublicUtil.compareValue(oldColumn.getFieldName(), newColumn.getFieldName()) || !PublicUtil.compareValue(oldColumn.getContent(), newColumn.getContent()) || !PublicUtil.compareValue(oldColumn.getLength(), newColumn.getLength()) || !PublicUtil.compareValue(oldColumn.getPointLength(), newColumn.getPointLength()) || !PublicUtil.compareValue(oldColumn.getType(), newColumn.getType()) || !PublicUtil.compareValue(oldColumn.getIsNull(), newColumn.getIsNull())
                || !PublicUtil.compareValue(oldColumn.getOrderNum(), newColumn.getOrderNum()) || !PublicUtil.compareValue(oldColumn.getIsKey(), newColumn.getIsKey()) || !PublicUtil.compareValue(oldColumn.getMainTable(), newColumn.getMainTable()) || !PublicUtil.compareValue(oldColumn.getMainField(), newColumn.getMainField()) || !PublicUtil.compareValue(oldColumn.getFieldDefault(), newColumn.getFieldDefault())) {
            return true;
        }
        return false;
    }
