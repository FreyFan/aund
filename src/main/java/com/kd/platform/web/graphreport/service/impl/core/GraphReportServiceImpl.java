package com.kd.platform.web.graphreport.service.impl.core;
...
import com.kd.platform.web.cgreport.dao.core.CgReportDao;
import com.kd.platform.web.graphreport.service.core.GraphReportServiceI;

@Service(value = "graphReportService")
@Transactional
public class GraphReportServiceImpl extends CommonServiceImpl implements GraphReportServiceI {
    @Autowired
    ...
    public Map<String, Object> queryCgReportConfig(String reportId) {
        ...
        Map<String, Object> mainM = jdbcDao.findForJdbc("SELECT * from PLATFORM.jform_graphreport_head where code=?", new Object[] { reportId }).get(0);
        List<Map<String, Object>> itemsM = jdbcDao.findForJdbc("SELECT * from PLATFORM.jform_graphreport_item where cgreport_head_id=? order by order_num asc", new Object[] { mainM.get("id") });
