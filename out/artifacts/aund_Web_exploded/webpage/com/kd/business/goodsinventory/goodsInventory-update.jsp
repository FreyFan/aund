...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="goodsInventoryController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="productId" name="productId" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${goodsInventoryPage.productId}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="productName" name="productName" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${goodsInventoryPage.productName}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="goodsNum" name="goodsNum" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${goodsInventoryPage.goodsNum}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="goodsUnit" name="goodsUnit" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${goodsInventoryPage.goodsUnit}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="responsibility" name="responsibility" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${goodsInventoryPage.responsibility}'>
							<span class="Validform_checktip"></span>
