...
<t:datagrid name="platformMinidaoList" title="menu.minidao.example" actionUrl="platformMinidaoController.do?datagrid" idField="id" fit="true" queryMode="group">
	...
	<t:dgDelOpt title="common.delete" url="platformMinidaoController.do?del&id={id}" />
	<t:dgToolBar title="common.add" icon="icon-add" url="platformMinidaoController.do?addorupdate" funname="add"></t:dgToolBar>
	<t:dgToolBar title="common.edit" icon="icon-edit" url="platformMinidaoController.do?addorupdate" funname="update"></t:dgToolBar>
	<t:dgToolBar title="common.search" icon="icon-search" url="platformMinidaoController.do?addorupdate" funname="detail"></t:dgToolBar>
</t:datagrid>
</div>
</div>