...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"
             action="platformNoteController.do?save" callback="@Override noteSubmitCallback">
    ...
    <table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
        <tr>
            ...
            <td class="value"><input class="inputxt" id="age" name="age" value="${platformNotePage.age}" datatype="n">
        ...
        <tr>
            ...
            <td class="value"><input class="Wdate" onClick="WdatePicker()" style="width: 150px" id="birthday"
                                     ...
                                     value="<fmt:formatDate value='${platformNotePage.birthday}' type="date" pattern="yyyy-MM-dd"/>">
                <span class="Validform_checktip"></span></td>
        </tr>
        <tr>
            ...
            <td class="value"><input class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
                                     ...
                                     value="<fmt:formatDate value='${platformNotePage.createdt}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>"
                                     datatype="*"> <span class="Validform_checktip"></span></td>
        </tr>
        <tr>
            <td align="right"><label class="Validform_label"> 用户名: </label></td>
            <td class="value"><input class="inputxt" id="name" name="name" value="${platformNotePage.name}"
                                     datatype="*6-16"> <span class="Validform_checktip"></span></td>
        </tr>
        <tr>
            <td align="right"><label class="Validform_label"> 工资: </label></td>
            <td class="value"><input class="inputxt" id="salary" name="salary" value="${platformNotePage.salary}"
