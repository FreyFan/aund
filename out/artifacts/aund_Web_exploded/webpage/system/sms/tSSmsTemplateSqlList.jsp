...
//导出
function ExportXls() {
	PlatformExcelExport("tSSmsTemplateSqlController.do?exportXls","tSSmsTemplateSqlList");
}

//模板下载
function ExportXlsByT() {
	PlatformExcelExport("tSSmsTemplateSqlController.do?exportXlsByT","tSSmsTemplateSqlList");
}
 </script>