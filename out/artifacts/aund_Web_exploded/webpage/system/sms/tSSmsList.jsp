...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSSmsList" fitColumns="false" title="common.messageSend.record" actionUrl="tSSmsController.do?datagrid" idField="id" fit="true" queryMode="group" sortName="createDate" sortOrder="desc">
...
//导出
function ExportXls() {
	PlatformExcelExport("tSSmsController.do?exportXls","tSSmsList");
}

//模板下载
function ExportXlsByT() {
	PlatformExcelExport("tSSmsController.do?exportXlsByT","tSSmsList");
}
 </script>