...
//导出
function ExportXls() {
	PlatformExcelExport("tSSmsTemplateController.do?exportXls","tSSmsTemplateList");
}

//模板下载
function ExportXlsByT() {
	PlatformExcelExport("tSSmsTemplateController.do?exportXlsByT","tSSmsTemplateList");
}
 </script>