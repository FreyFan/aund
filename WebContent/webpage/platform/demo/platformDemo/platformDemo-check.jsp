...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="platformDemoController.do?saveAuthor">
	<input id="id" name="id" type="hidden" value="${platformDemo.id }">
