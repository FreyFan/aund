...
<t:datagrid name="platformDemoList2" title="高级查询示例"  actionUrl="platformDemoController.do?datagrid"
	...
	<t:dgToolBar operationCode="edit" title="录入" icon="icon-edit" url="platformDemoController.do?addorupdate" funname="add"></t:dgToolBar>
...
function saveHeader1(){
 ...
 //var columnsFields =$('#platformDemoList2').datagrid('getColumnFields');
 var columnsFields =$('#platformDemoList2').datagrid('getColumns');
 var hiddencolumns = [],  columsDetail;

   for (var i=0;i< columnsFields.length;i++) {i.hidable=true;
                      //  columsDetail = $('#platformDemoList2').datagrid("getColumnOption", columnsFields[i]);
...
function restoreheader1(){
	...
	for(var i=0;i<cols.length;i++){
		try{
		if(cols.visible)$('#platformDemoList2').datagrid((cols[i].hidden==true?'hideColumn':'showColumn'),cols[i].field);
