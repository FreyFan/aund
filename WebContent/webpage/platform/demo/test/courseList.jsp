...
<script type="text/javascript" charset="utf-8">
	...
	function courseListExportXls() {
		PlatformExcelExport("courseController.do?exportXls","courseList");
	}
	function courseListExportXlsByT() {
		PlatformExcelExport("courseController.do?exportXlsByT","courseList");
	}
	function courseListWordXlsByT() {
		PlatformExcelExport("courseController.do?exportDocByT","courseList");
	}
	function courseListExportXlsByTe() {
		PlatformExcelExport("courseController.do?exportXlsByTest","courseList");
	}
...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 1px;">
		<t:datagrid name="courseList" title="课程" actionUrl="courseController.do?datagrid" idField="id" fit="true" queryMode="group">
