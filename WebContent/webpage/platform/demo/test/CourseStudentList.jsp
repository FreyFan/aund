...
<script type="text/javascript">
	...
	$('#addCustomBtn').bind('click', function(){   
 		 var tr =  $("#add_platformStudent_table_template tr").clone();
	 	 $("#add_platformStudent_table").append(tr);
	 	 resetTrNum('add_platformStudent_table');
    });  
	$('#delCustomBtn').bind('click', function(){   
      	$("#add_platformStudent_table").find("input:checked").parent().parent().remove();   
        resetTrNum('add_platformStudent_table'); 
    }); 
...
<table border="0" cellpadding="2" cellspacing="0" id="platformOrderCustom_table">
	...
	<tbody id="add_platformStudent_table">
