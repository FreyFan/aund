...
<div class="container-fluid"><a class="brand" href="#" target="_selft"><t:mutiLang langKey="common.platform"/> &nbsp;&nbsp;<span class="slogan"></span></a>
<div class="nav-no-collapse bootstrap-menu">

<ul class="nav pull-right usernav">
	<li style="line-height: 43px;"><span style="color: #CC33FF"><t:mutiLang langKey="common.user"/>:</span><span style="color: #666633">(${realName })</span> <span style="color: #CC33FF"><t:mutiLang langKey="common.role"/></span>:<span style="color: #666633">${roleName
	}</span></li>
...
<footer class="footer">
	<div class="container">
		<ul class="footer-links">
			<li style="display: inline;">&copy; 国电南瑞 北京科东电力控制系统有限责任公司 1996~<%=(Calendar.getInstance().get(Calendar.YEAR))%> All Right Reserved &copy;</li>
			<li style="display: inline;">&nbsp;技术支持:朱如升</li>
		</ul>
	</div>
</footer>
