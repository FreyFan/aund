...
<SCRIPT type="text/javascript">
	...
	$(function() {
		$('#layout_platform_onlineDatagrid').datagrid({
			...
			onLoadSuccess : function(data) {
				$('#layout_platform_onlinePanel').panel('setTitle', '( ' + data.total + ' )' + ' <t:mutiLang langKey="lang.user.online"/>');
			},
		...
		$('#layout_platform_onlinePanel').panel({
			tools : [ {
				iconCls : 'icon-reload',
				handler : function() {
					$('#layout_platform_onlineDatagrid').datagrid('load', {});
				}
			} ]
		});
		...
		$(".layout-expand").click(function(){
			...
			$("#layout_platform_onlinePanel").find(".datagrid-view").css("max-height","200px");
			$("#layout_platform_onlinePanel .datagrid-view .datagrid-view2 .datagrid-body").css("max-height","180px").css("overflow-y","auto");
		});
	});
	var onlineInterval;
...
<!-- 顶部-->
<div region="north" border="false" title="卓智网络智慧校园节能监管系统" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr>
    <!-- <td align="left" style="vertical-align: text-bottom;"><img src="plug-in/login/images/foot.png"></td> -->
    <td align="right" nowrap>
        <table>
            <tr>
                <td valign="top" height="50">
                    <span style="color: #CC33FF"><t:mutiLang langKey="common.user"/>:</span>
                    <span style="color: #666633">${realName }</span>
...
<div id="mainPanle" region="center" style="overflow: hidden;">
    ...
    <div id="maintabs" class="easyui-tabs" fit="true" border="false">
		<div class="easyui-tab" title="首页" style="padding: 1px; overflow: hidden;">
			<iframe name="homePage" id="homePage" scrolling="no" frameborder="0" src="smartSocketAnalyzeController.do?studentStatisticTabs&isIframe" style="width: 100%; height: 99.5%;"></iframe>
		</div>
	</div>
</div>
<!-- 右侧 -->
<div collapsed="true" region="east" iconCls="icon-reload" title="<t:mutiLang langKey="common.assist.tools"/>" split="true" style="width: 190px;"
    ...
    <div id="layout_platform_onlinePanel" data-options="fit:true,border:false" title=<t:mutiLang langKey="common.online.user"/>>
        <table id="layout_platform_onlineDatagrid"></table>
    </div>
    -->
    ...
    <div class="easyui-layout" fit="true" border="false">
		...
		<div region="center" border="false" style="overflow: hidden;">
			<div id="layout_platform_onlinePanel" fit="true" border="false" title='<t:mutiLang langKey="common.online.user"/>'>
				<table id="layout_platform_onlineDatagrid"></table>
			</div>
		</div>
	</div>
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #1fa3e5; padding-top: 2px">
		&copy; 福州卓智网络科技有限公司2014年~<%=(Calendar.getInstance().get(Calendar.YEAR))%> All Right Reserved &copy;
	</div>
</div>
