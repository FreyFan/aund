...
<tr>
    ...
    <img src="plug-in/login/images/logo.png"> 
	    <!--
	        ...
	        <div style="position: absolute; top: 75px; left: 33px;">PLATFORM Framework <span style="letter-spacing: -1px;">-3.5.2</span></div>
	    -->
    </td>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr style="height: 25px;" align="right">
                <td style="" colspan="2">
                    ...
                    <%--update-end--Author:Frey.Fan  Date:20140616 for：首页上方可以折叠--%>
                    </div>
                </td>
            </tr>
