				...
				<div class="navbar-header pull-left">
					...
					<a href="#" class="navbar-brand">
						<small>
							...
							<t:mutiLang langKey="platform.title"/>
						</small>
					</a>
					<!-- /section:basics/navbar.layout.brand -->
...
<!-- 				</div>/.sidebar-shortcuts -->
				...
				<ul class="nav nav-list">
					<li class="">
						<a  href="javascript:loadModule('首页','#')">
				...
				<div class="page-content" style="padding:0px" >
					...
					<div  id="tabs" >
							...
							<div id="tabs-1" style="padding:0px">
						 		<iframe style="width:100%;height:750px;margin:0px;padding:0px" scrolling="no" frameborder="0" id="center"  src="memberController.do?member&isIframe" ></iframe>
							</div>
					</div>
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							&copy; 上沉原通  2014~<%=(Calendar.getInstance().get(Calendar.YEAR))%> All Right Reserved &copy;
						</span>
