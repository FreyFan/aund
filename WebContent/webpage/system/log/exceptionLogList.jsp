...
<t:datagrid title="log.manage" name="logList" actionUrl="logController.do?exceptionDatagrid" idField="id" sortName="operatetime" sortOrder="desc" pageSize="100" extendParams="view:scrollview,">
