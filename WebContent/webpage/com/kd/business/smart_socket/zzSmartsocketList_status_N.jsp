...
<div class="easyui-layout " fit="true">
  ...
  <t:datagrid name="zzSmartsocketList" checkbox="true" fitColumns="false" title="智能插座状态" actionUrl="zzSmartsocketController.do?datagrid_status_N&status=N" idField="id" fit="true" queryMode="group" pageSize="20">
