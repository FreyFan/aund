...
<div class="easyui-layout " fit="true">
  ...
  <t:datagrid name="zzSmartsocketList" checkbox="true"  fitColumns="false" title="智能插座状态" actionUrl="zzSmartsocketController.do?datagrid" idField="id" fit="true" queryMode="group" pageSize="20">
   ...
   <t:dgCol title="状态"  field="status"    queryMode="single"  replace="has.conn_Y,has.noconn_N,has.nosignal_NS" style="background:#BCEE68;_Y,background:#FF4040;_N,background:#ABABAB;_NS"  query="true"  width="60"></t:dgCol>
   ...
   <t:dgCol title="IP地址"  field="ip"    queryMode="single" query="false" width="120" ></t:dgCol>
   <t:dgCol title="端口号"  field="port"    queryMode="single" query="false" width="120" ></t:dgCol>
...
<%--    <t:dgToolBar title="批量删除"  icon="icon-remove" url="zzSmartsocketController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
 ...
 $(document).ready(function(){
	 ...
	 window.setInterval("refreshGrid()",10000);
 });
 function refreshGrid(){

	 $("#zzSmartsocketList").datagrid('reload');
